...
class MapGl extends Component {
    ...
    componentDidMount() {
        ...
        map.on('load', function () {
            ...
            map.addImage('pulsing-dot-ship', pulsingDotShip);
            map.addLayer({
                'id': 'maine',
                'type': 'fill',
                'source': {
            ...
            map.addLayer({
                ...
                'source': 'points-ship',
                'layout': {
                    'icon-image': 'pulsing-dot-ship'
                }
            }); */
        });

        //air
        var airorigin = [104.2, 31.2];
        var airDestination = [117.032, 42.913];
        this.fly(map, airorigin, airDestination, 'pulsing-dot', pulsingDot, 'point');
        //ship
        var shipOrigin = [104.5, 31.5];
        var shipDestination = [117.032, 22.913];
